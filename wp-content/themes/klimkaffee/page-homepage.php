...
<main role="main">
    ...
    <section>
        ...
        <div class="page-content page-homepage">
            <div class="custom-container">
                <h2 class="introduction-title"><?php the_field('introduction_small_title') ?><br><span><?php the_field('introduction_big_title') ?></span></h2>
        ...
        <div class="row homepage-aanbod" style="background-image: url('<?php the_field('aanbod_background_image'); ?>');">

            <h3><?php the_field('aanbod_title'); ?></h3>
            ...
            <?php if( have_rows('aanbod_information_blocks') ): ?>
                ...
                <div class="col-md-4">
                    ...
                    <a class="red-btn" href="<?php the_sub_field('link_url'); ?>"><?php the_sub_field('link_text'); ?></a>
    ...
    <div class="row">
        ...
        <div class="col-md-6 dark-pink homepage-openingsuren">
            ...
            <h3><?php the_field('openingsuren_title'); ?></h3>
